...
This MCP (Model Content Protocol) server provides access to Amazon Simple Systems Manager (SSM) API functionality through HTTP, HTTPS, and STDIO transport modes.
