...
func ResetservicesettingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ResetServiceSettingRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AmazonSSM.ResetServiceSetting", cfg.BaseURL)
		...
		var result models.ResetServiceSettingResult
...
func CreateResetservicesettingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AmazonSSM_ResetServiceSetting",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ResetservicesettingHandler(cfg),
	}
}
