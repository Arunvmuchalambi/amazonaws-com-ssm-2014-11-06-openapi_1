...
func UpdateservicesettingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateServiceSettingRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AmazonSSM.UpdateServiceSetting", cfg.BaseURL)
		...
		var result models.UpdateServiceSettingResult
...
func CreateUpdateservicesettingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AmazonSSM_UpdateServiceSetting",
		...
		mcp.WithString("SettingValue", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdateservicesettingHandler(cfg),
	}
}
