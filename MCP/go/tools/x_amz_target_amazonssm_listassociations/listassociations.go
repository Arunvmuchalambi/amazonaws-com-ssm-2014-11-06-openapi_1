...
func ListassociationsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListAssociationsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AmazonSSM.ListAssociations%s", cfg.BaseURL, queryString)
		...
		var result models.ListAssociationsResult
...
func CreateListassociationsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AmazonSSM_ListAssociations",
		...
		mcp.WithString("AssociationFilterList", mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListassociationsHandler(cfg),
	}
}
