...
func GetparameterhistoryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetParameterHistoryRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AmazonSSM.GetParameterHistory%s", cfg.BaseURL, queryString)
		...
		var result models.GetParameterHistoryResult
...
func CreateGetparameterhistoryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AmazonSSM_GetParameterHistory",
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetparameterhistoryHandler(cfg),
	}
}
