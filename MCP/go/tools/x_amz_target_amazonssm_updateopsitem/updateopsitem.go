...
func UpdateopsitemHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateOpsItemRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AmazonSSM.UpdateOpsItem", cfg.BaseURL)
		...
		var result models.UpdateOpsItemResponse
...
func CreateUpdateopsitemTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AmazonSSM_UpdateOpsItem",
		...
		mcp.WithString("OperationalDataToDelete", mcp.Description("")),
		...
		mcp.WithString("OpsItemArn", mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateopsitemHandler(cfg),
	}
}
