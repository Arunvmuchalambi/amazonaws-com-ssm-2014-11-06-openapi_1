...
func UpdatemaintenancewindowtaskHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateMaintenanceWindowTaskRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AmazonSSM.UpdateMaintenanceWindowTask", cfg.BaseURL)
		...
		var result models.UpdateMaintenanceWindowTaskResult
...
func CreateUpdatemaintenancewindowtaskTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AmazonSSM_UpdateMaintenanceWindowTask",
		...
		mcp.WithString("TaskArn", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdatemaintenancewindowtaskHandler(cfg),
	}
}
