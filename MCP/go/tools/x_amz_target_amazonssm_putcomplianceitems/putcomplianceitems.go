...
func PutcomplianceitemsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.PutComplianceItemsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AmazonSSM.PutComplianceItems", cfg.BaseURL)
		...
		var result models.PutComplianceItemsResult
...
func CreatePutcomplianceitemsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AmazonSSM_PutComplianceItems",
		...
		mcp.WithString("UploadType", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    PutcomplianceitemsHandler(cfg),
	}
}
