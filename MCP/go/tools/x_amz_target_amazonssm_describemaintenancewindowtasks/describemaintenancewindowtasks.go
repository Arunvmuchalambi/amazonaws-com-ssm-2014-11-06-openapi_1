...
func DescribemaintenancewindowtasksHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeMaintenanceWindowTasksRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowTasks%s", cfg.BaseURL, queryString)
		...
		var result models.DescribeMaintenanceWindowTasksResult
...
func CreateDescribemaintenancewindowtasksTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DescribemaintenancewindowtasksHandler(cfg),
	}
}
