...
func DeleteresourcepolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteResourcePolicyRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AmazonSSM.DeleteResourcePolicy", cfg.BaseURL)
		...
		var result models.DeleteResourcePolicyResponse
