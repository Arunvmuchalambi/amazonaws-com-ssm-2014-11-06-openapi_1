...
func CreatemaintenancewindowHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateMaintenanceWindowRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AmazonSSM.CreateMaintenanceWindow", cfg.BaseURL)
		...
		var result models.CreateMaintenanceWindowResult
...
func CreateCreatemaintenancewindowTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AmazonSSM_CreateMaintenanceWindow",
		...
		mcp.WithString("Duration", mcp.Required(), mcp.Description("")),
		mcp.WithString("Cutoff", mcp.Required(), mcp.Description("")),
		...
		mcp.WithString("Schedule", mcp.Required(), mcp.Description("")),
		mcp.WithString("Tags", mcp.Description("")),
		mcp.WithString("AllowUnassociatedTargets", mcp.Required(), mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatemaintenancewindowHandler(cfg),
	}
}
