...
func DescribeopsitemsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeOpsItemsRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AmazonSSM.DescribeOpsItems%s", cfg.BaseURL, queryString)
		...
		var result models.DescribeOpsItemsResponse
...
func CreateDescribeopsitemsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AmazonSSM_DescribeOpsItems",
		...
		mcp.WithString("OpsItemFilters", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DescribeopsitemsHandler(cfg),
	}
}
