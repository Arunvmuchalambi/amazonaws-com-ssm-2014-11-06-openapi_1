...
func PutresourcepolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.PutResourcePolicyRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AmazonSSM.PutResourcePolicy", cfg.BaseURL)
...
func CreatePutresourcepolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AmazonSSM_PutResourcePolicy",
		...
		mcp.WithString("PolicyHash", mcp.Description("")),
	)
