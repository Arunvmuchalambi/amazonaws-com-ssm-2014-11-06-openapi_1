...
func GetmaintenancewindowtaskHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetMaintenanceWindowTaskRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AmazonSSM.GetMaintenanceWindowTask", cfg.BaseURL)
		...
		var result models.GetMaintenanceWindowTaskResult
...
func CreateGetmaintenancewindowtaskTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=AmazonSSM_GetMaintenanceWindowTask",
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetmaintenancewindowtaskHandler(cfg),
	}
}
