...
func GetcalendarstateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetCalendarStateRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=AmazonSSM.GetCalendarState", cfg.BaseURL)
		...
		var result models.GetCalendarStateResponse
